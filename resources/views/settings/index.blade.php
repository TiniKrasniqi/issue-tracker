    ...
    <div class="col-xl-12">
        <div class="card custom-card">
            <div class="card-header justify-content-between">
                <div class="card-title">{{ __('Change Website Settings') }}</div>
            </div>
            <div class="card-body">
                ...
                @method('PUT')
                   ...
                   <!-- User Status Select -->
                    ...
                    <div class="col-12"><button type="submit" class="btn btn-primary">{{ __('Save Changes') }}</button></div>
                </form>
