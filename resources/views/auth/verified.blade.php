...
<html lang="en" data-theme-mode="dark" >
    ...
    <head>
        ...
        <title>Verification Confirmed, Login to Continue</title>
                        ...
                        <div class="p-5">
                            <div class="mb-3">
                                <a href="/" class="d-flex justify-content-center">
                                    <img src="images/brand-logos/desktop-logo.png" alt="" class="authentication-brand desktop-logo" />
                                    <img src="images/brand-logos/desktop-dark.png" alt="" class="authentication-brand desktop-dark" />
                                </a>
                            </div>
                            <p class="h5 fw-semibold mb-2 text-center">Verification has been confirmed.</p>
                            <p class="mb-3 text-muted op-7 fw-normal text-center">Hello  !</p>
                            <div class="d-flex align-items-center mb-4 justify-content-center">

                                <div class=""><p class="mb-0 fw-semibold text-dark ">jhonslicer21@gmail.com</p></div>
                            </div>
                            <div class="row gy-3">
                                ...
                                <div class="col-xl-12 d-grid mt-2"><a href="index-2.html" class="btn btn-lg btn-primary">Unlock</a></div>
                            </div>
                            <div class="text-center">
                                <p class="fs-12 text-muted mt-4">
                                    Try unlock with different methods <a class="text-success" href="javascript:void(0);"><u>Finger print</u></a> / <a class="text-success" href="javascript:void(0);"><u>Face Id</u></a>
                                </p>
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="swiper-slide">
                                    <div class="text-fixed-white text-center p-5 d-flex align-items-center justify-content-center">
                                        <div>
                                            ...
                                            <h6 class="fw-semibold">Lockscreen</h6>
    ...
    <!-- Mirrored from spruko.com/demo/ynex/dist/html/lockscreen-cover.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 25 May 2023 15:37:18 GMT -->
</html>
