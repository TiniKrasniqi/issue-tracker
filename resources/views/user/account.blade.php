    ...
    <div class="col-xl-12">
        <div class="card custom-card">
            <div class="card-header">
                <div class="card-title">{{ __('My Account Members') }}</div>
            </div>
            <div class="card-body">
...
<div class="row">
    <div class="col-xl-12">
        <div class="card custom-card">
            <div class="card-header">
                <div class="card-title">{{ __('Accounts I Manage') }}</div>
            </div>
            <div class="card-body">
                <table id="file-export-2" class="table table-bordered text-nowrap" style="width: 100%;">
                    <thead>
                        <tr>
                            <th>{{ __('Name') }}</th>
                            <th>{{ __('Surname') }}</th>
